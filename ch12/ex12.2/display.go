// Exercise 12.2: Make display safe to use cyclic data structures by bounding the number of steps it takes before abandoning the recursion. (In section 13.3, we'll take see another way to detect cycles.)
package display
...
// Number of recursion calls of display function
// after the recursion is aborted
const maxDepth = 10
